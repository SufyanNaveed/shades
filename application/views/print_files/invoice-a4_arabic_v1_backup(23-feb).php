...
<div class="invoice-box">
    ...
    echo amountExchange($rming, $invoice['multi'], $invoice['loc']);
     echo '</strong></td>
        ...
        </table><br><div class="sign">' . $this->lang->line('Authorized person') . '</div><br><br><br><div class="sign2">(' . $employee['name'] . ')</div><div class="terms">' . $invoice['notes'] . '<hr><strong>' . $this->lang->line('Terms') . ':</strong>';
