<div class="content-body">
    <div class="card">
        <div class="card-header">
            ...
            <div style=" float: right; padding: 0 0 0 0; margin: 0 0 0 0px;"><b>Total Stock Price: <?php echo amountExchange($sum_stock_price); ?></b>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <table id="productstable" class="table table-striped table-bordered zero-configuration">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('Stock').' '.$this->lang->line('Price') ?></th>
