<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Batch') ?> <a
                        href="<?php echo base_url('services/add_batch') ?>"
                        class="btn btn-primary btn-sm rounded">
                    <?php echo $this->lang->line('Add new') ?>
                </a>  <a
                        href="<?php echo base_url('services') ?>?group=yes"
                        class="btn btn-purple btn-sm rounded"><i class="ft-grid"></i></a> <a
                        href="<?php echo base_url('services/batch') ?>"
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                ...
                <table id="batchtable" class="table table-striped table-bordered zero-configuration" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>#</th>
...
<!--            <input type="hidden" id="dashurl" value="services/prd_stats">-->
        </div>
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                table = $('#batchtable').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('services/batch_list')?>",
                        "type": "POST",
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p><?php echo $this->lang->line('delete this batch') ?></p>
                    </div>
                    <div class="modal-footer">
                        <input type="hidden" id="object-id" value="">
                        <input type="hidden" id="action-url" value="services/deleteBatch">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" id="view-action-url" value="services/view_over">
