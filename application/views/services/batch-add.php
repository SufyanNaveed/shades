<div class="content-body">
    <div class="card">
        <div class="card-header pb-0">
            <h5><?php echo $this->lang->line('Add New Batch') ?></h5>
            <hr>
            ...
            <form method="post" id="data_form">
                ...
                <div class="form-group row">
                    <div class="col-sm-4"><label class="col-form-label" for="name"><?php echo $this->lang->line('Batch Name') ?>*</label>
                        <input type="text" placeholder="Batch Name" class="form-control margin-bottom required" name="name">
                    </div>
                    ...
                    <div class="col-sm-4"><label class="col-form-label" for="qty"><?php echo $this->lang->line('Price') ?>*</label>
                        <input type="text" placeholder="Price" onchange="calculatePrice()" class="form-control margin-bottom required" id="price" name="price">
                    </div>

                </div>
                <div class="form-group row">
                    <div class="col-sm-6"><label class="col-form-label" for="qty"><?php echo $this->lang->line('Quantity') ?>*</label>
                        <input type="text" placeholder="Quantity" onchange="calculatePrice()" id="qty" class="form-control margin-bottom required" name="qty">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label class="col-form-label" for="daily_feed"><?php echo $this->lang->line('Daily Feed') ?></label>

                        <input type="text" placeholder="<?php echo $this->lang->line('Per Item Daily Feed') ?>*"
                               class="form-control margin-bottom required" name="daily_feed"
                               onkeypress="return isNumber(event)">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        <input type="submit" id="submit-data" class="btn btn-lg btn-blue margin-bottom"
                               value="<?php echo $this->lang->line('Add Batch') ?>" data-loading-text="Adding...">
                        <input type="hidden" value="services/addBatch" id="action-url">
                    </div>
                </div>
