<div class="content-body">
    <div class="card">
        <div class="card-header pb-0">
            <h5><?php echo $this->lang->line('Add New Service') ?></h5>
            <hr>
        ...
        <div class="card-body">
            <form method="post" id="data_form">
                ...
                <input type="hidden" name="act" value="add_service">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6"><label class="col-form-label"
                                                 for="service_name"><?php echo $this->lang->line('Service Name') ?>
                            *</label>
                        <input type="text" placeholder="Service Name"
                               class="form-control margin-bottom required" name="service_name">
                    </div>


                    <div class="col-sm-6"><label class="col-form-label"
                                                 for="service_code"><?php echo $this->lang->line('Service Code') ?></label>
                        <input type="text" placeholder="Service Code"
                               class="form-control" name="service_code">
                    </div>
                </div>
                <div class="form-group row">

                    <div class="col-sm-6"><label class="col-form-label"
                                                 for="pcat"><?php echo $this->lang->line('Service Category') ?>
                            *</label>
...
<!-- 
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label"
                           for="service_cat"><?php echo $this->lang->line('Warehouse') ?>*</label>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 control-label"
                           for="service_price"><?php echo $this->lang->line('Service Retail Price') ?>*</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <div class="input-group">
                            ...
                            <input type="text" name="service_disc" class="form-control"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <textarea placeholder="Description"
                                  class="form-control margin-bottom" name="service_desc"
                        ></textarea>
                    </div>
                </div>
                <!-- <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="submit" id="submit-data" class="btn btn-lg btn-blue margin-bottom"
                               value="<?php echo $this->lang->line('Add service') ?>" data-loading-text="Adding...">
                        <input type="hidden" value="services/addservice" id="action-url">
                    </div>
                </div>
                <!-- <button class="btn btn-pink add_serial btn-sm m-1">   <?php echo $this->lang->line('add_serial') ?></button><div id="added_service"></div> -->
...
<script>
    ...
    function calculateTotal(){
        ...
        const total = parseFloat(parseFloat($('#daily_feed').val()) + parseFloat($('#service_price').val()));
        $('#total').html(total);
        // alert(total)
    }
    ...
    $("#pcat").on('change', function () {
        ...
        $("#sub_cat").select2({
            ...
            ajax: {
                url: baseurl + 'services/sub_cat?id=' + tips,
                dataType: 'json',
                type: 'POST',
                quietMillis: 50,
